...
})({"7NYfL":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "17159d569f6e064f";
"use strict";
...
},{}],"l7fRG":[function(require,module,exports,__globalThis) {
// footer.js
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    if (homeIcon) moveBarToIcon(homeIcon);
    icons.forEach((icon)=>{
        const iconElement = document.getElementById(icon.id);
        if (iconElement) iconElement.addEventListener('mouseover', (event)=>{
            moveBarToIcon(iconElement);
        });
    });
});

},{}]},["7NYfL","l7fRG"], "l7fRG", "parcelRequirecff4", {})

//# sourceMappingURL=racingSimulation.9f6e064f.js.map
