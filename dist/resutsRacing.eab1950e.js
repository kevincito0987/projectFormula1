...
})({"aXbFT":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "f137c1ddeab1950e";
"use strict";
...
},{}],"81tlF":[function(require,module,exports,__globalThis) {
class UserConfig extends HTMLElement {
    constructor(){
        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .image{
                    ...
                    /* \u{1F4F1} Media Query para pantallas peque\xf1as */
            ...
            <div class="max-w-lg mx-auto bg-gray-900 text-white p-12 rounded-xl shadow-2xl border-2 border-gray-800 relative overflow-hidden container">
                <h1 class="text-4xl font-extrabold text-red-500 text-center tracking-wide mb-6">\u{1F680} Configuraci\xf3n de Perfil</h1>

                <div class="space-y-8 inputs">
                    <!-- Secci\xf3n Nombre de Usuario -->
                    <div class="bg-gray-800 p-6 rounded-xl shadow-md border border-gray-700 mb-4 user">
                        <label for="username" class="block text-lg font-semibold text-gray-300 mb-2">\u{1F464} Nombre:</label>
                    ...
                    <!-- Secci\xf3n Escuder\xeda Favorita -->
                    <div class="bg-gray-800 p-6 rounded-xl shadow-md border border-gray-700 escuderia">
                        <label for="team" class="block text-lg font-semibold text-gray-300 mb-2">\u{1F3CE} Escuder\xeda Favorita:</label>
                ...
                <div class="buttons mt-10 flex flex-col space-y-4">
                    <a id="saveBtn" class="w-full py-4 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white font-bold rounded-lg shadow-lg text-xl uppercase tracking-wide transition-all duration-300">\u{1F4BE} Guardar Cambios</a>
                    <a id="logoutBtn" class="w-full py-4 bg-gray-700 hover:bg-gray-800 text-white font-bold rounded-lg shadow-md text-xl uppercase tracking-wide transition-all duration-300">\u{1F6AA} Cerrar Sesi\xf3n</a>
                </div>
        ...
        this.shadowRoot.querySelector("#saveBtn").addEventListener("click", ()=>{
            ...
            if (newName.trim() !== "") this.shadowRoot.querySelector("h1").textContent = `Perfil de ${newName}`;
...
},{}]},["aXbFT","81tlF"], "81tlF", "parcelRequirecff4", {})

//# sourceMappingURL=resutsRacing.eab1950e.js.map
